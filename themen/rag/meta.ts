...
const thema: Thema = {
  ...
  pfade: [
    ...
    },
    {
      ...
      icon: '🔥',
      lektionenSlugs: ['halluzination', 'eval', 'lost-in-middle', 'uebungsaufgaben'],
    ...
    },
    {
      ...
      lektionen: [
        ...
        },
        {
          ...
          icon: '✏️',
          kurzbeschreibung: 'Chunking-Design, Pipeline-Entwurf und Mini-RAG mit Evaluation.',
          loader: () => import('@/components/kurse/rag/Uebungsaufgaben'),
        },
      ],
    },
  ],
