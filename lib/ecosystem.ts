...
export const NODES: EcoNode[] = [
  ...
  },
  {
    ...
    name:    'gehirn',
    emoji:   '🧠',
    tagline: 'KI-API + MCP-Server — Gen-Text/Image/Video, Wissenssystem, auge-framework als AI-Tool.',
    status:  'in-progress',
    group:   'Infra',
    port:    '4000',
    ...
    details: [
      ...
      'MCP-Server /mcp: search_snippets, recall_fact, get_roadmap, ecosystem_status',
      'Wissenssystem: Fakt · Snippet · Vorlage · Muster · Fehler in OrientDB',
      'speicher: MinIO intern, gehirn als S3-Gateway',
    ],
    deps: [],
    adrs: ['0006', '0007', '0008', '0014', '0015'],
    healthId: 'gehirn',
    context: [
      ...
      'MCP-Server /mcp (ADR 0015): search_snippets · store_snippet · recall_fact · get_roadmap · ecosystem_status',
      'Wissenssystem (ADR 0014): denker · erinnerer · merker · sucher — OrientDB-Klassen: Fakt, Snippet, Vorlage, Muster, Fehler',
      'speicher (ADR 0003): MinIO intern, /speicher/* als Gateway — generated-images, drop, documents',
    ...
    areas: [
      ...
      'MCP-Server — /mcp · Wissenssystem · Roadmaps · Ecosystem · Submissions',
      'Wissenssystem — /wissen/frag · /wissen/merke · /wissen/suche',
      'speicher — /speicher/upload · /speicher/:bucket/:key',
      'deploy — /deploy/status · /deploy/update/:service',
      'Admin-Panel (Port 3738, geplant) — OrientDB-CRUD, SSH-Tunnel, Wissenssystem-Browser',
    ],
    mx: 738, my: 268,
  },
  {
